...
#Region "Creation and Destruction"
	...
	Public Sub New(ByVal mdlFileReader As BinaryReader, ByVal mdlFileData As SourceMdlFileData31)
	...
	Public Sub ReadHitboxSets()
		If Me.theMdlFileData.hitboxSetCount > 0 Then
			...
			Try
				...
				Me.theMdlFileData.theHitboxSets = New List(Of SourceMdlHitboxSet31)(Me.theMdlFileData.hitboxSetCount)
				For i As Integer = 0 To Me.theMdlFileData.hitboxSetCount - 1
					...
					Dim aHitboxSet As New SourceMdlHitboxSet31()
	...
	Public Sub ReadBodyParts()
		If Me.theMdlFileData.bodyPartCount > 0 Then
			...
			Try
				...
				Me.theMdlFileData.theBodyParts = New List(Of SourceMdlBodyPart31)(Me.theMdlFileData.bodyPartCount)
				For i As Integer = 0 To Me.theMdlFileData.bodyPartCount - 1
					...
					fileOffsetStart = Me.theInputFileReader.BaseStream.Position
					Dim aBodyPart As New SourceMdlBodyPart31()
...
#Region "Private Methods"
	...
	Private Sub ReadHitboxes(ByVal hitboxSetInputFileStreamPosition As Long, ByVal aHitboxSet As SourceMdlHitboxSet31)
		If aHitboxSet.hitboxCount > 0 Then
			...
			Try
				...
				aHitboxSet.theHitboxes = New List(Of SourceMdlHitbox31)(aHitboxSet.hitboxCount)
	...
	Private Sub ReadMeshes(ByVal modelInputFileStreamPosition As Long, ByVal aModel As SourceMdlModel31)
	...
	Private Sub ReadVertexes(ByVal modelInputFileStreamPosition As Long, ByVal aModel As SourceMdlModel31)
	...
	Private Sub ReadTangents(ByVal modelInputFileStreamPosition As Long, ByVal aModel As SourceMdlModel31)
...
#Region "Data"
	...
	Protected theMdlFileData As SourceMdlFileData31
