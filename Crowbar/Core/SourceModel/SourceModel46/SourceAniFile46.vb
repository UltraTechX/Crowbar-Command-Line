...
Public Class SourceAniFile46
	Inherits SourceMdlFile46
...
#Region "Creation and Destruction"
	...
	Public Sub New(ByVal aniFileReader As BinaryReader, ByVal aniFileData As SourceFileData, ByVal mdlFileData As SourceFileData)
		...
		Me.theMdlFileData = CType(aniFileData, SourceMdlFileData46)
		Me.theRealMdlFileData = CType(mdlFileData, SourceMdlFileData46)
...
#Region "Methods"
	...
	Public Overridable Sub ReadAniAnimation(ByVal aniFileInputFileStreamPosition As Long, ByVal aniFileStreamEndPosition As Long, ByVal anAnimationDesc As SourceMdlAnimationDesc46, ByVal sectionFrameCount As Integer, ByVal sectionIndex As Integer)
...
#Region "Data"
	...
	Protected theRealMdlFileData As SourceMdlFileData46
