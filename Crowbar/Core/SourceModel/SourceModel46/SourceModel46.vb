...
Public Class SourceModel46
	Inherits SourceModel45
...
#Region "Private Methods"
	...
	Protected Overrides Sub ReadAniFile_Internal()
		If Me.theAniFileData Is Nothing Then
			Me.theAniFileData = New SourceAniFileData46()
			Me.theAniFileDataGeneric = Me.theAniFileData
		End If

		If Me.theMdlFileData Is Nothing Then
			Me.theMdlFileData = New SourceMdlFileData46()
			Me.theMdlFileDataGeneric = Me.theMdlFileData
		End If

		Dim aniFile As New SourceAniFile46(Me.theInputFileReader, Me.theAniFileData, Me.theMdlFileData)
	...
	Protected Overrides Sub ReadMdlFile_Internal()
		...
		Dim mdlFile As New SourceMdlFile46(Me.theInputFileReader, Me.theMdlFileData)
	...
	Protected Overrides Sub ReadVtxFile_Internal()
		If Me.theVtxFileData Is Nothing Then
			Me.theVtxFileData = New SourceVtxFileData46()
		End If

		Dim vtxFile As New SourceVtxFile46(Me.theInputFileReader, Me.theVtxFileData)
	...
	Protected Overrides Sub WriteQcFile()
		Dim qcFile As New SourceQcFile46(Me.theOutputFileTextWriter, Me.theQcPathFileName, Me.theMdlFileData, Me.theVtxFileData, Me.thePhyFileDataGeneric, Me.theAniFileData, Me.theName)
	...
	Protected Overrides Sub WriteMeshSmdFile(ByVal lodIndex As Integer, ByVal aVtxModel As SourceVtxModel, ByVal aModel As SourceMdlModel, ByVal bodyPartVertexIndexStart As Integer)
		Dim smdFile As New SourceSmdFile46(Me.theOutputFileTextWriter, Me.theMdlFileData, Me.theVvdFileData)
	...
	Protected Overrides Sub WritePhysicsMeshSmdFile()
		Dim physicsMeshSmdFile As New SourceSmdFile46(Me.theOutputFileTextWriter, Me.theMdlFileData, Me.thePhyFileDataGeneric)
	...
	Protected Overrides Sub WriteVrdFile()
		Dim vrdFile As New SourceVrdFile46(Me.theOutputFileTextWriter, Me.theMdlFileData)
	...
	Protected Overrides Sub WriteDeclareSequenceQciFile()
		Dim qciFile As New SourceQcFile46(Me.theOutputFileTextWriter, Me.theMdlFileData, Me.theName)
	...
	Protected Overrides Sub WriteBoneAnimationSmdFile(ByVal aSequenceDesc As SourceMdlSequenceDescBase, ByVal anAnimationDesc As SourceMdlAnimationDescBase)
		Dim smdFile As New SourceSmdFile46(Me.theOutputFileTextWriter, Me.theMdlFileData)
	...
	Protected Overrides Sub WriteMdlFileNameToMdlFile(ByVal internalMdlFileName As String)
		Dim mdlFile As New SourceMdlFile46(Me.theOutputFileBinaryWriter, Me.theMdlFileData)
