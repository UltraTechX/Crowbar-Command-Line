...
' Example: node\citadelfarnode from HL2 leak
'          citadelfarnode.dx7_2bone.vtx
'          citadelfarnode.dx80.vtx
Public Class SourceModel29
...
#Region "Methods"
	...
	Public Overloads Function WriteMeshSmdFile(ByVal smdPathFileName As String, ByVal lodIndex As Integer, ByVal aVtxModel As SourceVtxModel06, ByVal aModel As SourceMdlModel27, ByVal bodyPartVertexIndexStart As Integer) As AppEnums.StatusMessage
		...
		Try
			...
			Dim smdFile As New SourceSmdFile28(Me.theOutputFileTextWriter, Me.theMdlFileData)
...
#Region "Private Methods"
	...
	Protected Overrides Sub ReadMdlFileHeader_Internal()
		If Me.theMdlFileData Is Nothing Then
			Me.theMdlFileData = New SourceMdlFileData28()
			Me.theMdlFileDataGeneric = Me.theMdlFileData
		End If

		Dim mdlFile As New SourceMdlFile28(Me.theInputFileReader, Me.theMdlFileData)
	...
	Protected Overrides Sub ReadPhyFile_Internal()
		If Me.thePhyFileData Is Nothing Then
			Me.thePhyFileData = New SourcePhyFileData()
		End If

		Dim phyFile As New SourcePhyFile(Me.theInputFileReader, Me.thePhyFileData)
...
#Region "Data"
	...
	Private theMdlFileData As SourceMdlFileData28
