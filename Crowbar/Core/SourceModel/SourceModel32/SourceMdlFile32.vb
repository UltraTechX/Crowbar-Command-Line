...
Public Class SourceMdlFile32

#Region "Creation and Destruction"

	Public Sub New(ByVal mdlFileReader As BinaryReader, ByVal mdlFileData As SourceMdlFileData32)
	...
	Public Sub New(ByVal mdlFileWriter As BinaryWriter, ByVal mdlFileData As SourceMdlFileData32)
...
#Region "Methods"
	...
	Public Sub ReadBoneControllers()
		If Me.theMdlFileData.boneControllerCount > 0 Then
			...
			Try
				...
				Me.theMdlFileData.theBoneControllers = New List(Of SourceMdlBoneController32)(Me.theMdlFileData.boneControllerCount)
				For i As Integer = 0 To Me.theMdlFileData.boneControllerCount - 1
					...
					Dim aBoneController As New SourceMdlBoneController32()
	...
	Public Sub ReadHitboxSets()
		If Me.theMdlFileData.hitboxSetCount > 0 Then
			...
			Try
				...
				Me.theMdlFileData.theHitboxSets = New List(Of SourceMdlHitboxSet32)(Me.theMdlFileData.hitboxSetCount)
				For i As Integer = 0 To Me.theMdlFileData.hitboxSetCount - 1
					...
					Dim aHitboxSet As New SourceMdlHitboxSet32()
	...
	'			Me.theMdlFileData.theSequenceDescs = New List(Of SourceMdlSequenceDesc32)(Me.theMdlFileData.localSequenceCount)
	...
	'				Dim aSeqDesc As New SourceMdlSequenceDesc32()
	...
	'					If String.IsNullOrEmpty(aSeqDesc.theName) Then
	'						If Me.theMdlFileData.localSequenceCount = 1 Then
		...
		If Me.theMdlFileData.localSequenceCount > 0 Then
			...
			Try
				...
				For i As Integer = 0 To Me.theMdlFileData.localSequenceCount - 1
					...
					'NOTE: Not sure why these 4096 bytes were ever included; they are always zeroes.
					inputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
					Me.theInputFileReader.BaseStream.Seek(inputFileStreamPosition + 4096, SeekOrigin.Begin)
	...
	Public Sub ReadLocalAnimationDescs()
		If Me.theMdlFileData.animationCount > 0 Then
			...
			Try
				...
				Me.theMdlFileData.theAnimationDescs = New List(Of SourceMdlAnimationDesc32)(Me.theMdlFileData.animationCount)
				For i As Integer = 0 To Me.theMdlFileData.animationCount - 1
					...
					'fileOffsetStart = Me.theInputFileReader.BaseStream.Position
					Dim anAnimationDesc As New SourceMdlAnimationDesc32()
					...
					If anAnimationDesc.nameOffset <> 0 Then
						...
						End If
						If String.IsNullOrEmpty(anAnimationDesc.theName) Then
							If Me.theMdlFileData.animationCount = 1 Then
...
#Region "Private Methods"
	...
	Private Sub ReadHitboxes(ByVal hitboxSetInputFileStreamPosition As Long, ByVal aHitboxSet As SourceMdlHitboxSet32)
	...
	Private Sub ReadPoseKeys(ByVal seqInputFileStreamPosition As Long, ByVal aSeqDesc As SourceMdlSequenceDesc32)
	...
	Private Sub ReadEvents(ByVal seqInputFileStreamPosition As Long, ByVal aSeqDesc As SourceMdlSequenceDesc32)
	...
	Private Sub ReadAutoLayers(ByVal seqInputFileStreamPosition As Long, ByVal aSeqDesc As SourceMdlSequenceDesc32)
	...
	Private Sub ReadSequenceIkLocks(ByVal seqInputFileStreamPosition As Long, ByVal aSeqDesc As SourceMdlSequenceDesc32)
	...
	Private Sub ReadSequenceKeyValues(ByVal seqInputFileStreamPosition As Long, ByVal aSeqDesc As SourceMdlSequenceDesc32)
	...
	Private Sub ReadAnimations(ByVal animationDescInputFileStreamPosition As Long, ByVal anAnimationDesc As SourceMdlAnimationDesc32)
	...
	Private Sub ReadMdlMovements(ByVal animInputFileStreamPosition As Long, ByVal anAnimationDesc As SourceMdlAnimationDesc32)
	...
	Private Sub ReadMdlIkRules(ByVal animInputFileStreamPosition As Long, ByVal anAnimationDesc As SourceMdlAnimationDesc32)
...
#Region "Data"
	...
	Protected theMdlFileData As SourceMdlFileData32
