...
Public Class SourceQcFile32
	Inherits SourceQcFile

#Region "Creation and Destruction"

	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal outputPathFileName As String, ByVal mdlFileData As SourceMdlFileData32, ByVal phyFileData As SourcePhyFileData, ByVal vtxFileData As SourceVtxFileData06, ByVal modelName As String)
...
#Region "Private Methods"
	...
	Public Sub WriteIncludeModelCommands()
		...
		If Me.theMdlFileData.theSequenceGroups IsNot Nothing Then
			line = ""
			Me.theOutputFileStreamWriter.WriteLine(line)

			For i As Integer = 0 To Me.theMdlFileData.theSequenceGroups.Count - 1
	...
	Private Sub FillInWeightLists()
		If Me.theMdlFileData.theSequenceDescs IsNot Nothing Then
			Dim aSeqDesc As SourceMdlSequenceDesc32
	...
	Private Sub WriteAnimationLine(ByVal anAnimationDesc As SourceMdlAnimationDesc32)
		Dim line As String = ""
	...
	Private Sub WriteSequenceLine(ByVal aSequenceDesc As SourceMdlSequenceDesc32)
		Dim line As String = ""
	...
	Private Sub WriteSequenceOptions(ByVal aSequenceDesc As SourceMdlSequenceDesc32)
		Dim line As String = ""
	...
	'lookupControl( token )       
	Private Sub WriteAnimationOptions(ByVal aSequenceDesc As SourceMdlSequenceDesc32, ByVal anAnimationDesc As SourceMdlAnimationDesc32, ByVal impliedAnimDesc As SourceMdlAnimationDesc32)
		Dim line As String = ""
	...
	'worldspaceblend       //
	'worldspaceblendloop   // 
	Private Sub WriteCmdListOptions(ByVal aSequenceDesc As SourceMdlSequenceDesc32, ByVal anAnimationDesc As SourceMdlAnimationDesc32, ByVal impliedAnimDesc As SourceMdlAnimationDesc32)
		Dim line As String = ""
		...
		' weightlist "top_bottom"
		Dim aSeqDesc As SourceMdlSequenceDesc32 = Nothing
		If aSequenceDesc Is Nothing Then
	...
	Private Sub WriteSequenceWeightListLine(ByVal aSeqDesc As SourceMdlSequenceDesc32)
		Dim line As String = ""
	...
	Private Sub WriteSequenceBlendInfo(ByVal aSeqDesc As SourceMdlSequenceDesc32)
		Dim line As String = ""
	...
	Private Sub WriteSequenceDeltaInfo(ByVal aSeqDesc As SourceMdlSequenceDesc32)
		Dim line As String = ""
	...
	Private Sub WriteSequenceLayerInfo(ByVal aSeqDesc As SourceMdlSequenceDesc32)
	...
	Private Sub WriteHBoxRelatedCommands()
		...
		Dim aHitboxSet As SourceMdlHitboxSet32
	...
	Private Sub WriteHBoxCommands(ByVal theHitboxes As List(Of SourceMdlHitbox32), ByVal commentTag As String, ByVal hitboxSetName As String, ByRef theSkipBoneInBBoxCommandWasUsed As Boolean)
		Dim line As String = ""
		Dim aHitbox As SourceMdlHitbox32
	...
	Public Sub WriteControllerCommand()
		Dim line As String = ""
		Dim boneController As SourceMdlBoneController32
