...
#Region "Creation and Destruction"
	...
	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal outputPathFileName As String, ByVal mdlFileData As SourceMdlFileData44, ByVal vtxFileData As SourceVtxFileData07, ByVal phyFileData As SourcePhyFileData, ByVal aniFileData As SourceAniFileData44, ByVal modelName As String)
	...
	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal outputPathFileName As String, ByVal mdlFileData As SourceMdlFileData44, ByVal modelName As String)
		Me.theOutputFileStreamWriter = outputFileStream
		Me.theMdlFileData = mdlFileData
		Me.theModelName = modelName
...
#Region "Private Methods"
	...
	Public Sub WriteModelCommand()
		...
		Dim aBodyPart As SourceMdlBodyPart = Nothing
	...
	Public Sub WriteKeyValues(ByVal keyValuesText As String, ByVal commandOrOptionText As String)
		Dim line As String = ""
		Dim startText As String = "mdlkeyvalue"
