...
Public Class SourceMdlFile28

#Region "Creation and Destruction"

	Public Sub New(ByVal mdlFileReader As BinaryReader, ByVal mdlFileData As SourceMdlFileData28)
		...
		If Me.theMdlFileData.localSequenceCount > 0 Then
			...
			Try
				...
				For i As Integer = 0 To Me.theMdlFileData.localSequenceCount - 1
					...
					'		aSeqDesc.anim(rowIndex)(columnIndex) = Me.theInputFileReader.ReadInt16()
					'	Next
					'Next
...
#Region "Data"
	...
	Protected theMdlFileData As SourceMdlFileData28
