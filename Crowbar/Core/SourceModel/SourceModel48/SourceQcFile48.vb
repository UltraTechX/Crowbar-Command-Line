...
Public Class SourceQcFile48
	Inherits SourceQcFile

#Region "Creation and Destruction"

	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal outputPathFileName As String, ByVal mdlFileData As SourceMdlFileData48, ByVal vtxFileData As SourceVtxFileData07, ByVal phyFileData As SourcePhyFileData, ByVal aniFileData As SourceAniFileData48, ByVal modelName As String)
	...
	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal mdlFileData As SourceMdlFileData48, ByVal modelName As String)
		Me.theOutputFileStreamWriter = outputFileStream
		Me.theMdlFileData = mdlFileData
		Me.theModelName = modelName
	End Sub
...
#Region "Private Methods"
	...
	'				stack.Push(New IntermediateExpression("(1 - " + Me.theMdlFileData.theFlexControllers(CInt(eyeUpDownIndex.theExpression)).theName + ") * (1 - " + Me.theMdlFileData.theFlexControllers(aFlexOp.index).theName + ") * " + Me.theMdlFileData.theFlexControllers(CInt(closeLidIndex.theExpression)).theName + " // WARNING: This is an approximation of the expression that can only be done via DMX file.", 10))
	...
	'			flexRuleEquation = "// " + flexRuleEquation + stack.Peek().theExpression + " // [Decompiler failed to parse expression. Please report the error with the following info: this qc file, the mdl filename that was decompiled, and where the mdl file was found (e.g. the game's name or a web link).]"
	'		Else
	...
	Public Sub WriteIllumPositionCommand()
		...
		'FROM: [48] SourceEngine2007_source se2007_src\src_main\utils\studiomdl\write.cpp
	...
	Private Sub WriteAnimBlockSizeCommand()
		...
		If Me.theMdlFileData.animBlockCount > 0 Then
			...
			line += " "
			line += "32"
			'TEST: Commented-out because HL2 zombie\classic.mdl recompiled nearly perfect without it. 
	...
	Private Sub WriteAnimationLine(ByVal anAnimationDesc As SourceMdlAnimationDesc48)
		Dim line As String = ""
	...
	Private Sub WriteSequenceOptions(ByVal aSequenceDesc As SourceMdlSequenceDesc)
		...
		Dim impliedAnimDesc As SourceMdlAnimationDesc48 = Nothing
	...
	'lookupControl( token )       
	Private Sub WriteAnimationOptions(ByVal aSequenceDesc As SourceMdlSequenceDesc, ByVal anAnimationDesc As SourceMdlAnimationDesc48, ByVal impliedAnimDesc As SourceMdlAnimationDesc48)
		Dim line As String = ""
	...
	Private Sub WriteCmdListLocalHierarchyOption(ByVal anAnimationDesc As SourceMdlAnimationDesc48)
		Dim line As String = ""
