...
#Region "Methods"
	...
	Public Overloads Function WriteMeshSmdFile(ByVal smdPathFileName As String, ByVal lodIndex As Integer, ByVal aVtxModel As SourceVtxModel06, ByVal aModel As SourceMdlModel37, ByVal bodyPartVertexIndexStart As Integer, ByVal bodyPartIndex As Integer) As AppEnums.StatusMessage
		...
		Try
			...
			Dim smdFile As New SourceSmdFile35(Me.theOutputFileTextWriter, Me.theMdlFileData)
...
#Region "Private Methods"
	...
	Protected Overrides Sub WriteQcFile()
		Dim qcFile As New SourceQcFile35(Me.theOutputFileTextWriter, Me.theQcPathFileName, Me.theMdlFileData, Me.thePhyFileDataGeneric, Me.theVtxFileData, Me.theName)
	...
	Protected Overrides Sub WritePhysicsMeshSmdFile()
		Dim physicsMeshSmdFile As New SourceSmdFile35(Me.theOutputFileTextWriter, Me.theMdlFileData, Me.thePhyFileDataGeneric)
