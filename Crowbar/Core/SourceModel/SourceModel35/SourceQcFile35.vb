...
Public Class SourceQcFile35
	Inherits SourceQcFile

#Region "Creation and Destruction"

	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal outputPathFileName As String, ByVal mdlFileData As SourceMdlFileData35, ByVal phyFileData As SourcePhyFileData, ByVal vtxFileData As SourceVtxFileData06, ByVal modelName As String)
...
#Region "Data"
	...
	Private theMdlFileData As SourceMdlFileData35
