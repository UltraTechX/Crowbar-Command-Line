...
Public Class SourceQcFile27
	Inherits SourceQcFile

#Region "Creation and Destruction"

	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal outputPathFileName As String, ByVal mdlFileData As SourceMdlFileData27, ByVal modelName As String)
...
#Region "Private Methods"
	...
	Private Sub WriteHBoxRelatedCommands()
		...
		If Me.theMdlFileData.theHitboxes Is Nothing OrElse Me.theMdlFileData.theHitboxes.Count < 1 Then
			Exit Sub
		End If
		...
		Me.WriteHBoxCommands(Me.theMdlFileData.theHitboxes, commentTag)
	End Sub

	Private Sub WriteHBoxCommands(ByVal theHitboxes As List(Of SourceMdlHitbox31), ByVal commentTag As String)
		Dim line As String = ""
