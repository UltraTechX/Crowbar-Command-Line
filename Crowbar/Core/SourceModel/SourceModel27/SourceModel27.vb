...
#Region "Methods"
	...
	Public Overloads Function WriteMeshSmdFile(ByVal smdPathFileName As String, ByVal lodIndex As Integer, ByVal aVtxModel As SourceVtxModel06, ByVal aModel As SourceMdlModel27, ByVal bodyPartVertexIndexStart As Integer) As AppEnums.StatusMessage
		...
		Try
			...
			Dim smdFile As New SourceSmdFile27(Me.theOutputFileTextWriter, Me.theMdlFileData)
...
#Region "Private Methods"
	...
	Protected Overrides Sub ReadMdlFileHeader_Internal()
		If Me.theMdlFileData Is Nothing Then
			Me.theMdlFileData = New SourceMdlFileData27()
			Me.theMdlFileDataGeneric = Me.theMdlFileData
		End If

		Dim mdlFile As New SourceMdlFile27(Me.theInputFileReader, Me.theMdlFileData)
