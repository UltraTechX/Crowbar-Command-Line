...
#Region "Methods"
	...
	Public Overloads Function WriteMeshSmdFile(ByVal smdPathFileName As String, ByVal lodIndex As Integer, ByVal aVtxModel As SourceVtxModel06, ByVal aModel As SourceMdlModel37, ByVal bodyPartVertexIndexStart As Integer) As AppEnums.StatusMessage
		...
		Try
			...
			Dim smdFile As New SourceSmdFile36(Me.theOutputFileTextWriter, Me.theMdlFileData)
...
#Region "Private Methods"
	...
	Protected Overrides Sub ReadMdlFileHeader_Internal()
		If Me.theMdlFileData Is Nothing Then
			Me.theMdlFileData = New SourceMdlFileData36()
			Me.theMdlFileDataGeneric = Me.theMdlFileData
		End If

		Dim mdlFile As New SourceMdlFile36(Me.theInputFileReader, Me.theMdlFileData)
	...
	Protected Overrides Sub WriteQcFile()
		Dim qcFile As New SourceQcFile36(Me.theOutputFileTextWriter, Me.theQcPathFileName, Me.theMdlFileData, Me.thePhyFileDataGeneric, Me.theVtxFileData, Me.theName)
	...
	Protected Overrides Sub WritePhysicsMeshSmdFile()
		Dim physicsMeshSmdFile As New SourceSmdFile36(Me.theOutputFileTextWriter, Me.theMdlFileData, Me.thePhyFileDataGeneric)
